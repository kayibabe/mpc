...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("payer_type",
                  sa.Enum("insurance", "medical_scheme", name="payertype"),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  sa.Enum("active", "suspended", "expired", name="memberstatus"),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  sa.Enum("requested", "approved", "rejected", name="preauthstatus"),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  sa.Enum("draft", "submitted", "approved", "partially_approved",
                          "rejected", "settled", name="claimstatus"),
